kmer_list_file = r'C:\Users\cbr7q\OneDrive\Coding\Coursera\Genome Assembly dataset.txt'
...
def Genome_Assembly(kmer_list_file): #input is a string of spaced separated kmers
    with open(kmer_list_file, 'r') as file:
        text_file_kmers = str(file.readlines(5)).strip("'[]'").replace("\\n","")
    raw_kmers = text_file_kmers 
    kmers = raw_kmers.split()
...
print(Genome_Assembly(kmer_list_file))
